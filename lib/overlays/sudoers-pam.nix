# bosh_sudoers, restrict_su_command, password_policies stages:
# - Append #includedir to /etc/sudoers and write /etc/sudoers.d/bosh_sudoers with NOPASSWD rule
# - Add pam_wheel.so to /etc/pam.d/su for su restriction
