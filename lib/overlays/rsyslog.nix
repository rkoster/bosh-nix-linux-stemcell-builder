# rsyslog_config stage: copy rsyslog configuration files, systemd overrides, and utility scripts.
# Reproduces stemcell_builder/stages/rsyslog_config/apply.sh by copying rsyslog.conf,
